package com.juiceybeans.slugmosis;

import com.juiceybeans.slugmosis.block.ModBlocks;
import com.juiceybeans.slugmosis.data.loot_modifiers.InjectItemModifier;
import com.juiceybeans.slugmosis.data.loot_modifiers.ModLootModifiers;
import com.juiceybeans.slugmosis.event.HorseFeedingEvent;
import com.juiceybeans.slugmosis.event.WorldgenModificationEvent;
import com.juiceybeans.slugmosis.item.ModItems;
import com.juiceybeans.slugmosis.tab.ModTabs;
...
@Mod(Slugmosis.MOD_ID)
public class Slugmosis {

    public static final String MOD_ID = "slugmosis";
    ...
    public static void registerModifiers(RegisterEvent event) {
        event.register(ForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS,
                codecRegisterHelper -> codecRegisterHelper.register(Slugmosis.id("sniffer_digging"),
